...
\subsubsection{伽马-伽马辐射密度和中子测量确定岩石组成体积分数}
...
图\ref{fig21}中的例子显示了一个复合碳酸盐岩剖面\footnote[3]{一些部分来自原始数据且用于例子}。数据是经AAPG许可，摘自\textit{"Basic Well Log Analysis"}, \textit{Asquith and Krygowski (2004)}。 该剖面由具有混合岩性的碳酸盐岩组成。
